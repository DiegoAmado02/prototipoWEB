...
<!-- Custom Theme Style -->
<link href="http://localhost:8081/prototipoWEB/build/css/custom.min.css"
	rel="stylesheet">
</head>
<style>
</style>
<body class="nav-md">
							...
							<div class="row">
								...
								<div class="col-md-3">
									...
									<iframe scrolling="no" style="border-width: 0px;"
										src="http://DESKTOP-OR9DHJV:8080/api/rest/public/process/completness?&amp;width=350&amp;height=400"
								...
								<div class="col-md-3">
									...
									<br>
									<iframe scrolling="no" style="border-width: 0px;"
										src="http://DESKTOP-OR9DHJV:8080/api/rest/public/process/traceability?&amp;width=350&amp;height=400"
										width="350" height="400"></iframe>
									Porcentaje de datos completos en fuente, datos de creacion y
									actualización.
								</div>
								<div class="col-md-3">
									<h2>Compliance</h2>
									<br>
									<iframe scrolling="no" style="border-width: 0px;"
										src="http://DESKTOP-OR9DHJV:8080/api/rest/public/process/compliance?&amp;width=350&amp;height=400"
										width="350" height="400"></iframe>
									Porcentaje de columnas con un estandar (formato asociado) y
									porcentaje de columnas que realmente cumplen este formato.
								...
								<div class="col-md-3 ">
									...
									<table class="table">
										...
										<c:forEach var="ids" items="${tokens_total}">
											...
											<tr>
												<td><div class="links">
														<a href="#"><c:out value="${ids.tokens}" /></a>
													</div></td>
	...
	<!-- jQuery -->
	<script
		src="http://localhost:8081/prototipoWEB/vendors/jquery/dist/jquery.min.js"></script>
	<!-- Bootstrap -->
	<script
		src="http://localhost:8081/prototipoWEB/vendors/bootstrap/dist/js/bootstrap.min.js"></script>
	<!-- FastClick -->
